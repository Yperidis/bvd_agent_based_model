Status from December 2016. By Thomas Isele.
...
Source farm: The moving irc events of the cow need to be inserted in the set of future irc events of this farm. Therefore, a cow needs to keep track of these events.
